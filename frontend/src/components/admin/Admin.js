...
const Admin = () => {
    ...
    const allIns = async() => {
        const res = await axios.get("http://localhost:8800/user/allInstructors")
        setIns(res.data)
    }
    ...
    return (
        <>
            ...
            <div className="main-container">
                ...
                <div className="main">
                    ...
                    <div className="report-header">
                        ...
                        <button className="view"><Link style={{
                            textDecoration: "none",
                            color: "white"
                        }} to="http://localhost:3000/admin/users/list"> View All</Link></button>
                    </div>
                ...
                <div className="report-container">
                    <div className="report-header">
                        <h1 className="recent-Articles">Instructor Details</h1>
                        <button className="view"><Link style={{
                            textDecoration: "none",
                            color: "white"
                        }} to="http://localhost:3000/admin/instructors/list"> View All</Link></button>
                    </div>

                    <div className="report-body">
                        <div className="report-topic-heading">
                            <h3 className="t-op">Instructor Name</h3>
                            <h3 className="t-op-email">Email</h3>
                        </div>

                        <div className="items">
                            {
                                ins && ins.slice(0,5).map((ins) => {
                                    return (
                                        <table>
                                        <div className="item1">
                                            <td><h3 className="t-op-nextlvl">{ins.name}</h3></td>
                                            <td><h3 className="t-op-nextlvl">{ins.email}</h3></td>
                                        </div>
                                    </table>
                                    )
                                })
